...
export const experiences: Experience[] = [
  {
    ...
    summary: [
      '영상 콘텐츠 관리·유통 솔루션을 만드는 회사로, CJ ENM 같은 대형 미디어 고객사를 대상으로 한 서비스(Cocos)를 Laravel 기반으로 풀스택 개발·운영',
  ...
  },
  {
    ...
    summary: [
      'TIL(오늘 배운 것) 기록 서비스 "hiaryAI"를 만드는 스타트업으로, 프론트엔드 개발자로 참여해 화면 설계부터 인증 연동까지 단독으로 담당',
      '이메일 회원가입 · 로그인 · 비밀번호 재설정 등 인증 플로우와 온보딩 화면을 구현하고 Firebase Auth 연동',
      '블로그/TIL 대시보드 모듈을 구조화하고 Tiptap 기반 에디터를 연동, 백엔드 API와 연결',
    ],
    techStack: ['TypeScript', 'Vue.js', 'Pinia', 'Tiptap', 'Firebase', 'AWS'],
    link: '',
  },
  {
    company: '(주)온어스링크잇',
    ...
    summary: [
      '모터사이클·자동차 긴급출동/정비 서비스를 운영하는 회사로, 콜센터 지원용 백오피스, 기사 배차 앱 "온어스라이더", 할리데이비슨 견인 접수페이지 등 3개 서비스의 풀스택 개발 담당',
